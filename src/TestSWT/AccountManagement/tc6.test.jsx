...
describe('LoginPageCard', () => {
    ...
    it('should login successfully as a staff member with valid credentials', async () => {
        const staffResponse = {
            data: {
                token: 'staff-token',
                role: 'SALES', // or any other staff role
                // Add other relevant data
            },
        };

        axios.post.mockResolvedValueOnce(staffResponse);
